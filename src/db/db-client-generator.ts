...
export class DbClientGenerator {
  ...
  generate(): string {
    ...
    const modelClientEntries = this.schema.models.map((model) =>
      this.generateModelClientEntry(model.name),
    );
    const viewClientEntries = this.schema.views.map((view) =>
      this.generateViewClientEntry(view.name),
    );
  ...
  private generateModelClientEntry(modelName: string): string {
  ...
  private generateViewClientEntry(viewName: string): string {
...
export function generateDbClientFiles(schema: Schema): {
  dbTypes: string;
  dbClient: string;
  modelMeta: string;
} {
