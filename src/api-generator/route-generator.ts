...
export class RouteGenerator {
  ...
  private generateListRoute(clientKey: string, modelHasPolicies: boolean): string[] {
    if (!modelHasPolicies) {
      return [
        "router.get('/', async (c) => {",
        '  const db = c.get(\'db\');',
  ...
  private generateCreateRoute(clientKey: string, modelHasPolicies: boolean): string[] {
    if (!modelHasPolicies) {
      return [
