...
import {
  ...
  toRouteFileName,
  toRouteImportName,
} from '../api/utils/route-naming.js';
...
export class ViewRouteGenerator {
  ...
  generate(): string | null {
    ...
    if (operations.has('list')) {
      handlerBlocks.push(
        this.generateListRoute(clientKey, viewHasPolicies, listQuerySchemaName, constantPrefix),
      );
    }
...
export function generateViewRouteFiles(schema: Schema): Map<string, string> {
...
export function getViewRouteMountEntries(
  schema: Schema,
