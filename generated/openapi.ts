  ...
  "paths": {
      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "description": "Filter status with in"
          },
          {
            "name": "totalAmount",
            "in": "query",
          ...
          },
          {
            ...
            "description": "Filter totalAmount with gt"
          },
          {
            ...
            "description": "Filter totalAmount with gte"
          },
          {
            "name": "totalAmount_lt",
            "in": "query",
            ...
            "description": "Filter totalAmount with lt"
          },
          {
            ...
            "description": "Filter totalAmount with lte"
          },
          {
            "name": "items",
            "in": "query",
          ...
          },
          {
            ...
            "description": "Sort field (prefix with - for desc). Allowed: id, userId, status, totalAmount, items, createdAt, updatedAt"
          },
          {
            "name": "include",
            "in": "query",
            ...
            "description": "Comma-separated relation paths (dot nesting). Available: user, products"
          }
        ],
        "responses": {
          "200": {
      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "description": "Filter description with contains"
          },
          {
            ...
            "description": "Filter description with startsWith"
          },
          {
            ...
            "description": "Filter description with endsWith"
          },
          {
            "name": "price",
            "in": "query",
          ...
          },
          {
            ...
            "description": "Filter price with gt"
          },
          {
            "name": "price_gte",
            "in": "query",
            ...
            "description": "Filter price with gte"
          },
          {
            "name": "price_lt",
            "in": "query",
            ...
            "description": "Filter price with lt"
          },
          {
            "name": "price_lte",
            "in": "query",
            ...
            "description": "Filter price with lte"
          },
          {
            "name": "stock",
            "in": "query",
          ...
          },
          {
            ...
            "description": "Filter stock with gt"
          },
          {
            "name": "stock_gte",
            "in": "query",
            ...
            "description": "Filter stock with gte"
          },
          {
            "name": "stock_lt",
            "in": "query",
            ...
            "description": "Filter stock with lt"
          },
          {
            "name": "stock_lte",
            "in": "query",
            ...
            "description": "Filter stock with lte"
          },
          {
            "name": "category",
            "in": "query",
          ...
          },
          {
            ...
            "description": "Filter category with contains"
          },
          {
            "name": "category_startsWith",
            "in": "query",
            "required": false,
            "schema": {
              "type": "string"
            },
            "description": "Filter category with startsWith"
          },
          {
            "name": "category_endsWith",
            "in": "query",
            "required": false,
            "schema": {
              "type": "string"
            },
            "description": "Filter category with endsWith"
          },
          {
            "name": "tags",
            "in": "query",
          ...
          },
          {
            ...
            "description": "Filter tags with contains"
          },
          {
            "name": "tags_startsWith",
            "in": "query",
            "required": false,
            "schema": {
              "type": "array",
            ...
            "description": "Filter tags with startsWith"
          },
          {
            "name": "tags_endsWith",
            "in": "query",
            ...
            "description": "Filter tags with endsWith"
          },
          {
            "name": "createdAt",
            "in": "query",
          ...
          },
          {
            ...
            "description": "Sort field (prefix with - for desc). Allowed: id, name, description, price, stock, category, tags, metadata, createdAt, updatedAt"
          },
          {
            "name": "include",
            "in": "query",
            ...
            "description": "Comma-separated relation paths (dot nesting). Available: orders"
          }
        ],
        "responses": {
          "200": {
    ...
    "/product-orders": {
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "description": "Filter id with gte"
          },
          {
            "name": "id_lt",
            "in": "query",
          ...
          },
          {
            ...
            "description": "Filter id with lte"
          },
          {
            "name": "orderId",
            "in": "query",
            ...
            "description": "Filter by orderId"
          },
          {
            "name": "orderId_contains",
            "in": "query",
            "required": false,
            "schema": {
              "type": "string",
            ...
            "description": "Filter orderId with contains"
          },
          {
            "name": "orderId_startsWith",
            "in": "query",
            "required": false,
            "schema": {
              "type": "string",
            ...
            "description": "Filter orderId with startsWith"
          },
          {
            "name": "orderId_endsWith",
            "in": "query",
            "required": false,
            "schema": {
              "type": "string",
            ...
            "description": "Filter orderId with endsWith"
          },
          {
            "name": "productId",
            "in": "query",
          ...
          },
          {
            ...
            "description": "Filter productId with contains"
          },
          {
            "name": "productId_startsWith",
            "in": "query",
            "required": false,
            "schema": {
              "type": "string",
            ...
            "description": "Filter productId with startsWith"
          },
          {
            "name": "productId_endsWith",
            "in": "query",
            "required": false,
            "schema": {
              "type": "string",
            ...
            "description": "Filter productId with endsWith"
          },
          {
            "name": "quantity",
            "in": "query",
          ...
          },
          {
            ...
            "description": "Filter quantity with gt"
          },
          {
            "name": "quantity_gte",
            "in": "query",
            ...
            "description": "Filter quantity with gte"
          },
          {
            "name": "quantity_lt",
            "in": "query",
            ...
            "description": "Filter quantity with lt"
          },
          {
            "name": "quantity_lte",
            "in": "query",
            ...
            "description": "Filter quantity with lte"
          },
          {
            "name": "price",
            "in": "query",
          ...
          },
          {
            ...
            "description": "Sort field (prefix with - for desc). Allowed: id, orderId, productId, quantity, price"
          },
          {
            "name": "include",
            "in": "query",
            ...
            "description": "Comma-separated relation paths (dot nesting). Available: order, product"
          }
        ],
        "responses": {
          "200": {
      ...
      "post": {
        ...
        "responses": {
          "201": {
            "description": "Created ProductOrder",
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/ProductOrderResponse"
    ...
    "/product-orders/{orderId}/{productId}": {
      "get": {
        "tags": [
          "ProductOrder"
        ],
        ...
        "responses": {
          "200": {
            "description": "ProductOrder record",
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/ProductOrderResponse"
      ...
      "put": {
        ...
        "responses": {
          "200": {
            "description": "Updated ProductOrder",
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/ProductOrderResponse"
      ...
      "delete": {
        ...
        "responses": {
          "200": {
            "description": "Deleted ProductOrder",
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/ProductOrderResponse"
